...
class GraphConvolution(nn.Module):
    ...
    def reset_parameters(self):
        ...
        if self.bias is not None:
            ...
            bound = torch.Tensor([1 / math.sqrt(fan_in)], dtype=torch.float32)
            self.bias = ops.uniform(self.bias.shape, minval = -bound, maxval = bound)
    ...
    def forward(self, text, adj):
        ...
        return ops.relu(output.type_as(text))
