...
from lib.models.mstl import resnet as resnet_module
...
class BackboneBase(nn.Cell):
    ...
    def __init__(self, backbone: nn.Cell, train_backbone: bool, num_channels: int, return_interm_layers: bool,
                 net_type="resnet"):
        super().__init__()
...
class Backbone(BackboneBase):
    ...
    def __init__(self, name: str,
        ...
        if "resnet" in name:
            ...
            try:
                ckpt = ms.load_checkpoint(ckpt_path, map_location='cpu')
                missing_keys, unexpected_keys = backbone.load_param_into_net(ckpt, strict=False)
...
class Joiner_NOPE(nn.SequentialCell):
